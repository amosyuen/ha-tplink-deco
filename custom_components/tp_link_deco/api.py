import asyncio
import aiohttp
from aiohttp.hdrs import COOKIE, CONTENT_TYPE, SET_COOKIE
...
class TpLinkDecoApi:
    ...
    async def _async_post(self, context, url, params, data) -> dict:
    ...
    def _encode_sign(self, dataLength):
        seq_with_data_len = self._seq + dataLength
        auth_hash = (
    ...
    def _decrypt_data(self, context, data):
        if data == "":
            self._clear_auth()
